    ...
    public partial class Init : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        ...
                        ReportTitle = c.String(maxLength: 256),
                        ReportComment = c.String(maxLength: 4000),
                        ReportStartDate = c.DateTime(storeType: "date"),
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.UserItems", t => t.RefUserId, cascadeDelete: true)
                .Index(t => t.RefUserId)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .Index(t => t.UserProviderId, unique: true)
        ...
        {
            DropForeignKey("dbo.ReportItems", "RefUserId", "dbo.UserItems");
            DropIndex("dbo.UserItems", new[] { "CreatedAt" });
            DropIndex("dbo.UserItems", new[] { "Email" });
            DropIndex("dbo.UserItems", new[] { "UserProviderId" });
            DropIndex("dbo.ReportItems", new[] { "CreatedAt" });
            DropIndex("dbo.ReportItems", new[] { "RefUserId" });
